        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <button type="submit" name="method" value="doLogin" class="btn btn-primary btn-block">Войти</button>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-12">
                            <a href=<?php echo __URL__ . "index.php/register" ?>>На страницу регистрации</a>
                        </div>
                    </div>
                </form>
            </div>
